...
X_train_original, Y_train = dl.prepareDatasetTotalRegression(train, scaler)
test = originalTest.copy()
X_test_original, Y_test = dl.prepareDatasetTotalRegression(test, scaler)
...
df.to_csv("total_regression.csv", index = False)
